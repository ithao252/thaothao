...
bool ValidUser(char x)	//Qui ước <USERNAME> chỉ chứa dấu . _ và các kí tự 0-9, a-z, A-Z
{
...
bool ValidPass(char x)	//Qui ước <PASSWORD> từ kí tự 33 đến 126
{
	if (x >= 33 && x <= 126)
		return true;
	return false;
...
bool ValidFullname(char x)	//Qui ước <FULLNAME> chỉ chứa các kí tự A-Z, a-z
{
